...
-- Migration: novo tipo de desfecho "Recadastro" (2/2 — constraint)
--
-- Continuação de 20260727000001 (que só adicionou o valor 'recadastro' ao
-- enum tipo_desfecho, numa transação separada — ver comentário lá para o
-- porquê da divisão). Aqui, já em nova transação, o valor novo pode ser
-- referenciado normalmente: recria desfechos_campos_por_tipo com o branch
-- para 'recadastro', exigindo todas as colunas específicas de outros tipos
-- como null (recadastro não carrega nenhum dado adicional).
-- ============================================================================
